...
class UpdateStudentForm(forms.ModelForm):
    ...
    class Meta:
        model = MyUser
        fields = ('email', 'password', 'first_name', 'last_name','contact_info','description','programmingLanguage','yearsOfExperience','speciality','is_student', 'is_professor', 'is_engineer')
        widgets = {
            'description': forms.Textarea()
        }
    def clean_password(self):
